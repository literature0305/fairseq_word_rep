...
# input_subword_dir = 'examples/translation/iwslt14.tokenized.de-en'
# input_word_dir = 'examples/translation/iwslt14.tokenized.de-en/tmp'
# output_word_dir = 'examples/translation/iwslt14.tokenized.de-en_word'
input_subword_dir = sys.argv[1]
output_word_dir = sys.argv[2]
input_word_dir = input_subword_dir + '/tmp'
